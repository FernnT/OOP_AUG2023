...
public class CommisionEmployee {
    ...
    public CommisionEmployee(int empID, float totalHoursWorked, float ratePerHour, double totalSales) {
        this.empID = empID;
    ...
    public CommisionEmployee(int empID, String empName, Date empBirthDate, Date empHiredDate, float totalHoursWorked, float ratePerHour, double totalSales) {
        this.empID = empID;
    ...
    public void displayInfo(){
       System.out.println("NAME: " + this.empName);
        ...
        System.out.println(" RATE /Hour " + this.ratePerHour);
    ...
    public String toString() {
        return "CommisionEmployee{" + "empID=" + empID + ", empName=" + empName + ", empBirthDate=" + empBirthDate + ", empHiredDate=" + empHiredDate + ", totalHoursWorked=" + totalHoursWorked + ", ratePerHour=" + ratePerHour + ", totalSales=" + totalSales + '}';
    }
