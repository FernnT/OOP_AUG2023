...
/////////HourlyEmployee with full constructor///////////////////////////////////
        HourlyEmployee emp3 = new HourlyEmployee(3,new Name("Lassy","Firssy","M"), new Date(12,12,1912), new Date(11,11,2021), 500, 3);
         //ComputeSalary()
         ...
         //ToString()
          ...
          System.out.println("");
           ...
           //CommisionEmployee full constructor////////////////////////////////
            CommisionEmployee cEmp3 = new CommisionEmployee(3,new Name("Poe","Panda","P"),new Date(6,7,1967),new Date(1,12,2021),60000);
             //ComputeSalary()
 ...
 System.out.println("//////////////////Base Commision Employee/////////////////////////");
         ...
         //ToString()
          ...
          //BasePlusCommisionEmployee full constructor/////////////////////////
            BasePlusCommisionEmployee bEmp3 = new BasePlusCommisionEmployee(3,new Name("Qaz","Bee","K"),new Date(31,3,2003),new Date(3,3,2023), 300000, 300);
              //ComputeSalary()
